...
Public Class Form3
    Dim lc As ListenClass3
    Dim GameB(9) As Button         '每一個格子(按鈕)
    ...
    Public BlockGameB(9) As Integer   '已被選取的格子
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Form1.CheckBox1.Checked Then
            ...
            Try
                ...
                lc = New ListenClass3(tcpListener, Me)
    ...
    Public Function checkLine()
        ...
        For i = 0 To 6 Step 3
            ...
            While j < i + 3                 '水平線
                ...
                j += 1
            End While
            If countOneLine = 3 Then         '如果都被圈走則成為一條線 線+1
                HowmanyLine += 1
            End If
        Next
        For i = 0 To 2
        ...
        Next
        countOneLine = 0
        For i = 2 To 6 Step 2               '斜線
            If GameB(i).Enabled = False Then
                countOneLine += 1
            End If
        Next
        If countOneLine = 3 Then         '如果都被圈走則成為一條線 線+1
    ...
    Public Sub setLabel3(ByVal tmpStr As String)
        'Console.WriteLine("setting Label3 completed")
        ...
        Else
            ...
            ElseIf tmpStr = "Waiting" Then
                ...
                Label3.Left = 122
            End If
            'Console.WriteLine("set Label3 completed")
        End If
    End Sub
    Public Sub setLabel4(ByVal tmpStr As String)
        If Label4.InvokeRequired Then
            ...
            Invoke(d, tmpStr)
        Else
            Label4.Text = "You need to connect " & tmpStr & " line"
        End If
    End Sub
    ...
    Private Sub GameButton_Click(sender As Object, e As EventArgs) Handles Button4.Click, Button5.Click, Button6.Click, Button7.Click, Button8.Click, Button9.Click, Button10.Click, Button11.Click, Button12.Click
        Dim GBNum As String
...
Public Class ListenClass3
    ...
    Public Sub New(ByVal tmpSocket As TcpListener, ByVal tmpForm3 As Form3)
    ...
    Private Sub receiveThreadProc()
        Try
            ...
            Do
                ...
                Select Case tmpStr.Substring(0, 4)
                    Case "RADY"
                        Dim msg As Byte() = Encoding.Default.GetBytes("Strt" & f3.GAMEMODE)
                        networkStream.Write(msg, 0, msg.Length)
                        'clientSocket.Send(msg, 0, msg.Length, SocketFlags.None)
                        Console.WriteLine("sendMode")
                    Case "NumB"
                        f3.setLabel3("Please Choose number")
                        Console.WriteLine("recNumb+" & tmpStr.Substring(4))
                        f3.CanceledBlock("")
                        f3.setGameNumber(tmpStr.Substring(4))
                        f3.setLabel2("目前有" & f3.checkLine() & "條連線")
                        Console.WriteLine("set completely ")
                        Dim msg As Byte() = Encoding.Default.GetBytes("NowL" & f3.Winline)
                        networkStream.Write(msg, 0, msg.Length)
                        'clientSocket.Send(msg, 0, msg.Length, SocketFlags.None)
                        If f3.checkWin(f3.Winline) Then
                            f3.setLabel2("You Win")
                        End If
                    Case "NowL"
                        If f3.checkWin(tmpStr.Substring(4)) Then
                            If f3.GameOver = False Then
                                f3.setLabel2("You Lose")
                            End If
                        End If
                    Case "GGGG"
                        f3.GGSMIIDA()
